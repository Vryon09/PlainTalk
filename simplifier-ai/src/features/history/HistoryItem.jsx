...
import { getExplainedById } from "../../services/apiExplain";
...
function HistoryItem() {
  ...
  // const explained = useSelector((state) =>
  //   state.history.prevExplained.find((e) => e.id === +historyId),
  // );

  const { data: explained, isPending } = useQuery({
    queryKey: ["selectedExplained", historyId],
    queryFn: () => getExplainedById(historyId),
  });
